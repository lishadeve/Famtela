...
using Famtela.Infrastructure.Extensions;
using Famtela.Server.Extensions;
using Famtela.Server.Middlewares;
using Hangfire;
...
using System.IO;
using Famtela.Server.Filters;
using Famtela.Server.Managers.Preferences;
using Microsoft.Extensions.Localization;

namespace Famtela.Server
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IStringLocalizer<Startup> localizer)
        {
            ...
            {
                DashboardTitle = localizer["Famtela Jobs"],
