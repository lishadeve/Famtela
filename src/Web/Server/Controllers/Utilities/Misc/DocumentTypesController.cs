...
using Famtela.Application.Features.DocumentTypes.Commands.Delete;
using Famtela.Application.Features.DocumentTypes.Queries.Export;
...
namespace Famtela.Server.Controllers.Utilities.Misc
{
