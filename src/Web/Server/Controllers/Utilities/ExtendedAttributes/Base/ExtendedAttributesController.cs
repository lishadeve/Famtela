...
using Famtela.Application.Features.ExtendedAttributes.Commands.Delete;
...
using Famtela.Application.Features.ExtendedAttributes.Queries.GetById;
using Famtela.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace Famtela.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
