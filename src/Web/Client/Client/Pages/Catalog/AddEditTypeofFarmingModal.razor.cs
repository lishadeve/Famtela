...
{
    public partial class AddEditTypeofFarmingModal
    {
        [Inject] private ITypeofFarmingManager TypeofFarmingManager { get; set; }

        [Parameter] public AddEditTypeofFarmingCommand AddEditTypeofFarmingModel { get; set; } = new();
        ...
        {
            var response = await TypeofFarmingManager.SaveAsync(AddEditTypeofFarmingModel);
