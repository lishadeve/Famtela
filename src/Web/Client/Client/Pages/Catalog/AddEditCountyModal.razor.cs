...
{
    public partial class AddEditCountyModal
    {
        [Inject] private ICountyManager CountyManager { get; set; }

        [Parameter] public AddEditCountyCommand AddEditCountyModel { get; set; } = new();
        ...
        {
            var response = await CountyManager.SaveAsync(AddEditCountyModel);
