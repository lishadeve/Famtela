...
{
    public partial class AddEditWeightEstimateModal
    {
        [Inject] private IWeightEstimateManager WeightEstimateManager { get; set; }

        [Parameter] public AddEditWeightEstimateCommand AddEditWeightEstimateModel { get; set; } = new();
        ...
        {
            var response = await WeightEstimateManager.SaveAsync(AddEditWeightEstimateModel);
