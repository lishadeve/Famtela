...
{
    public partial class AddEditColorModal
    {
        [Inject] private IColorManager ColorManager { get; set; }

        [Parameter] public AddEditColorCommand AddEditColorModel { get; set; } = new();
        ...
        {
            var response = await ColorManager.SaveAsync(AddEditColorModel);
