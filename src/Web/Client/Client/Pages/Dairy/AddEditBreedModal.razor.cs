...
{
    public partial class AddEditBreedModal
    {
        [Inject] private IBreedManager BreedManager { get; set; }

        [Parameter] public AddEditBreedCommand AddEditBreedModel { get; set; } = new();
        ...
        {
            var response = await BreedManager.SaveAsync(AddEditBreedModel);
