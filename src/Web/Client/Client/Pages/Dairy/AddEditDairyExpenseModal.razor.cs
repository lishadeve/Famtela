...
{
    public partial class AddEditDairyExpenseModal
    {
        [Inject] private IDairyExpenseManager DairyExpenseManager { get; set; }

        [Parameter] public AddEditDairyExpenseCommand AddEditDairyExpenseModel { get; set; } = new();
        ...
        {
            var response = await DairyExpenseManager.SaveAsync(AddEditDairyExpenseModel);
