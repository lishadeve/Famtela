...
{
    public partial class AddEditAgeModal
    {
        [Inject] private IAgeManager AgeManager { get; set; }

        [Parameter] public AddEditAgeCommand AddEditAgeModel { get; set; } = new();
        ...
        {
            var response = await AgeManager.SaveAsync(AddEditAgeModel);
