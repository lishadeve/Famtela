...
{
    public partial class AddEditTypeofFeedModal
    {
        [Inject] private ITypeofFeedManager TypeofFeedManager { get; set; }

        [Parameter] public AddEditTypeofFeedCommand AddEditTypeofFeedModel { get; set; } = new();
        ...
        {
            var response = await TypeofFeedManager.SaveAsync(AddEditTypeofFeedModel);
