...
{
    public partial class AddEditEggModal
    {
        [Inject] private IEggManager EggManager { get; set; }

        [Parameter] public AddEditEggCommand AddEditEggModel { get; set; } = new();
        ...
        {
            var response = await EggManager.SaveAsync(AddEditEggModel);
