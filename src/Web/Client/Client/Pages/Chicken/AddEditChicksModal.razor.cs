...
{
    public partial class AddEditChicksModal
    {
        [Inject] private IChicksManager ChicksManager { get; set; }

        [Parameter] public AddEditChickCommand AddEditChickModel { get; set; } = new();
        ...
        {
            var response = await ChicksManager.SaveAsync(AddEditChickModel);
