...
{
    public partial class AddEditLayersModal
    {
        [Inject] private ILayersManager LayersManager { get; set; }

        [Parameter] public AddEditLayerCommand AddEditLayerModel { get; set; } = new();
        ...
        {
            var response = await LayersManager.SaveAsync(AddEditLayerModel);
