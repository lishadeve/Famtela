...
using Famtela.Client.Infrastructure.Authentication;
using Famtela.Client.Infrastructure.Managers;
using Famtela.Client.Infrastructure.Managers.Preferences;
...
using Famtela.Client.Infrastructure.Managers.ExtendedAttribute;
using Famtela.Domain.Entities.ExtendedAttributes;
using Famtela.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace Famtela.Client.Extensions
{
    public static class WebAssemblyHostBuilderExtensions
    {
        private const string ClientName = "Famtela.API";
        ...
        public static WebAssemblyHostBuilder AddClientServices(this WebAssemblyHostBuilder builder)
        {
            builder
                ...
                .AddScoped<FamtelaStateProvider>()
                .AddScoped<AuthenticationStateProvider, FamtelaStateProvider>()
                .AddManagers()
