...
using Famtela.Client.Infrastructure.Routes;
using Famtela.Shared.Constants.Storage;
    ...
    public class AuthenticationManager : IAuthenticationManager
    {
        ...
        public async Task<IResult> Login(TokenRequest model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await ((FamtelaStateProvider)this._authenticationStateProvider).StateChangedAsync();
        ...
        public async Task<IResult> Logout()
        {
            ...
            ((FamtelaStateProvider)_authenticationStateProvider).MarkUserAsLoggedOut();
