...
namespace Famtela.Infrastructure.Helpers
{
    public static class ClaimsHelper
    {
        ...
        public static async Task<IdentityResult> AddPermissionClaim(this RoleManager<FamtelaRole> roleManager, FamtelaRole role, string permission)
        {
