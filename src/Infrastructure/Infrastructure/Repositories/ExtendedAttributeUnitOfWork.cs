...
namespace Famtela.Infrastructure.Repositories
{
    public class ExtendedAttributeUnitOfWork<TId, TEntityId, TEntity> : IExtendedAttributeUnitOfWork<TId, TEntityId, TEntity> where TEntity : AuditableEntity<TEntityId>
    {
        ...
        private readonly FamtelaContext _dbContext;
        private bool _disposed;
        private Hashtable _repositories;
        private readonly IAppCache _cache;

        public ExtendedAttributeUnitOfWork(FamtelaContext dbContext, ICurrentUserService currentUserService, IAppCache cache)
        {
