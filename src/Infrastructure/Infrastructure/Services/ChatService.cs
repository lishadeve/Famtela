...
namespace Famtela.Infrastructure.Services
{
    public class ChatService : IChatService
    {
        private readonly FamtelaContext _context;
        private readonly IMapper _mapper;
        private readonly IUserService _userService;
        private readonly IStringLocalizer<ChatService> _localizer;

        public ChatService(
            FamtelaContext context,
            IMapper mapper,
        ...
        public async Task<IResult> SaveMessageAsync(ChatHistory<IChatUser> message)
        {
            ...
            await _context.ChatHistories.AddAsync(_mapper.Map<ChatHistory<FamtelaUser>>(message));
