...
namespace Famtela.Infrastructure.Services.Identity
{
    public class IdentityService : ITokenService
    {
        ...
        private readonly SignInManager<FamtelaUser> _signInManager;
        private readonly IStringLocalizer<IdentityService> _localizer;

        public IdentityService(
            UserManager<FamtelaUser> userManager, RoleManager<FamtelaRole> roleManager,
            IOptions<AppConfiguration> appConfig, SignInManager<FamtelaUser> signInManager,
        ...
        private async Task<string> GenerateJwtAsync(FamtelaUser user)
        {
            var token = GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user));
            return token;
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(FamtelaUser user)
        {
