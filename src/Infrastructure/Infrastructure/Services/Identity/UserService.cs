...
using AutoMapper;
using Famtela.Application.Exceptions;
...
using Famtela.Infrastructure.Specifications;
using Famtela.Shared.Constants.Role;
...
namespace Famtela.Infrastructure.Services.Identity
{
    public class UserService : IUserService
    {
        private readonly UserManager<FamtelaUser> _userManager;
        private readonly RoleManager<FamtelaRole> _roleManager;
        ...
        public UserService(
            UserManager<FamtelaUser> userManager,
            IMapper mapper,
            RoleManager<FamtelaRole> roleManager,
        ...
        private async Task<string> SendVerificationEmail(FamtelaUser user, string origin)
        {
        ...
        public async Task<IResult> UpdateRolesAsync(UpdateUserRolesRequest request)
        {
            ...
            if (user.Email == "mukesh@Famtela.com")
            {
        ...
        public async Task<string> ExportToExcelAsync(string searchString = "")
        {
            ...
            var result = await _excelService.ExportAsync(users, sheetName: _localizer["Users"],
                mappers: new Dictionary<string, Func<FamtelaUser, object>>
                {
