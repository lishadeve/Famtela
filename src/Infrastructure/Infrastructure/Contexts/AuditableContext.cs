using Famtela.Application.Enums;
...
{
    public abstract class AuditableContext : IdentityDbContext<FamtelaUser, FamtelaRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, FamtelaRoleClaim, IdentityUserToken<string>>
    {
